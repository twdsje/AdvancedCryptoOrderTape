...
/******/ 	var hotCurrentHash = "24859eada9d03d4f1bd2"; // eslint-disable-line no-unused-vars
...
function subscribeToTimer(cb) {
  ...
  socket.addEventListener('message', function (timestamp) {
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(60),B=__webpack_require__(11),C=__webpack_require__(5),ba=__webpack_require__(61),da=__webpack_require__(62),ea=__webpack_require__(63),fa=__webpack_require__(64),ia=__webpack_require__(65),D=__webpack_require__(12);
...
var _tape = __webpack_require__(192);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return React.createElement(_tape.Tape, null);
    }
  }]);
...
var _order = __webpack_require__(193);
...
var Tape = exports.Tape = function (_React$Component) {
  _inherits(Tape, _React$Component);

  function Tape(props) {
    _classCallCheck(this, Tape);

    var _this = _possibleConstructorReturn(this, (Tape.__proto__ || Object.getPrototypeOf(Tape)).call(this, props));

    var initialArray = [];
    _this.state = { orders: initialArray, minSize: 0 };
    (0, _api.subscribeToTimer)(function (err, input) {
      return _this.addRow(input);
    });

    _this.minSizeChange = _this.minSizeChange.bind(_this);
    return _this;
  }

  _createClass(Tape, [{
    key: 'addRow',
    value: function addRow(msg) {
      var input = JSON.parse(msg.data);

      if (input.size > this.state.minSize) {
        var _orders = this.state.orders;
        _orders.unshift(input);
    ...
    key: 'minSizeChange',
    value: function minSizeChange(e) {
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', { type: 'text', onChange: this.minSizeChange })
        ),
        React.createElement(
          'table',
          null,
          ...
          React.createElement(
            ...
            this.state.orders.map(function (order) {
              return React.createElement(_order.Order, { key: order.trade_id, time: order.time, size: order.size, price: order.price, side: order.side });
            })
          )
        )
      );
...
var Order = exports.Order = function (_React$Component) {
  ...
  function Order(props) {
    ...
    var minutest = _this.pad(minutes, 2);
    var hours = date.getHours();
    var hourst = _this.pad(hours, 2);
    var seconds = date.getSeconds();
    var secondst = _this.pad(seconds, 2);
    var millis = date.getMilliseconds();
    var millist = _this.pad(millis, 3);
    ...
    _this.state = { time: formatedDate, price: formatedPrice };
    return _this;
  }
